...
assignment = Assignment.create(title: 'server issues', employee_id: 16, issue_id: 17, description: 'this is a generic description while we seed our database.')
...
assignment = Assignment.create(title: 'server issues', employee_id: 16, issue_id: 18, description: 'this is a generic description while we seed our database.')

assignment = Assignment.create(title: 'server issues', employee_id: 16, issue_id: 19, description: 'this is a generic description while we seed our database.')
...
ssignment = Assignment.create(title: 'server issues', employee_id: 68, issue_id: 16 , description: 'this is a generic description while we seed our database.')
assignment = Assignment.create(title: 'network issues', employee_id: 68, issue_id: 7 , description: 'this is a generic description while we seed our database.')
assignment = Assignment.create(title: 'chocolate issues', employee_id: 68, issue_id: 9 , description: 'this is a generic description while we seed our database.')
assignment = Assignment.create(title: 'server issues', employee_id: 68, issue_id: 11 , description: 'this is a generic description while we seed our database.')
