...
assignment = Assignment.create(title: 'server issues', employee_id: 8, issue_id: 7 , description: 'this is a generic description while we seed our database.')
...
assignment = Assignment.create(title: 'server issues', employee_id: 8, issue_id: 12, description: 'this is a generic description while we seed our database.')
